...
insert into student(student_code, name, birth, gender, major_code,phone) values('s12','정오빈','20030202','M','m3','01000000020');
...
-- 간단하고, 코드가 짧고, 빠르게 작성 가능.. 하지만 복잡해지면 가독성이 떨어진다. 다양한 조인방식을 사용할 수 없다.
select s.name, s.major_code, m.major_name
